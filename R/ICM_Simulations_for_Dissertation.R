source("Single_Trial_ICM.R")
library(psych)
library(retimes)
library(gamlss.dist)

ICMSimulation <- function(
  Participants = 40,
  Num_SubBlocks = 128,
  Simulations = 1,
  Length_Sub_Block = 6,
  ...
  listofdfs2 <- list()
  listofdfs3 <- list()
#ICM_L2 <- ICMSimulation(40, 1, Length_Sub_Block = 6, Trial_Comparisons = c(1,2,3,4,5,6), LangOrder = c("L2", "L2", "L2","L1", "L2", "L2"), Simulations = 5, u = .50, SwitchOrder = c("Stay", "Stay", "Stay", "Switch", "Switch", "Stay"))
